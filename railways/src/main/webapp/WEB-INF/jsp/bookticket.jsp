    ...
    <script>
      ...
      window.onload = function () {
        ...
        for (var x in stations) {
          sourcesStations.options[sourcesStations.options.length] = new Option(
            x,
            x
          );
        }
        sourcesStations.onchange = function () {
          ...
          for (var y in stations[this.value]) {
            destinationStation.options[destinationStation.options.length] =
              new Option(y, y);
          }
        };
